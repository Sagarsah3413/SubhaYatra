          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
              <button
                ...
                className={`flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-semibold text-white transition-all duration-300 hover:scale-105 shadow-lg cursor-pointer relative z-10 ${isBookmarked
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-semibold border-2 transition-all duration-300 hover:scale-105 shadow-lg ${theme === 'dark'
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button
                ...
                className={`flex items-center justify-center gap-2 px-4 py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 ${theme === 'dark'

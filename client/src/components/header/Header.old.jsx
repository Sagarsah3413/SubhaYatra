...
import NepaliCalendar from "../../pages/NepaliCalendar.jsx";
...
import { LOCATION_FALLBACKS, KATHMANDU_NEIGHBORHOODS, SUPPORTED_LANGUAGES } from './client/src/constants/locationFallbacks.js'
import { reverseGeocodeWithMaxAccuracy } from '../../services/geocodingService.js';
...
export const Header = () => {
  ...
  const tryNeighborhoodMapping = async (latitude, longitude) => {
    ...
    for (const neighborhood of KATHMANDU_NEIGHBORHOODS) {
...
const getHeaderClasses = (theme) => {
  return `sticky top-0 z-50 w-full px-4 py-3 ${theme === "dark"
    ...
    } border-b flex justify-between items-center relative transition-all duration-300 will-change-transform transform-gpu min-h-[72px] max-h-[72px] before:absolute before:inset-0 before:bg-gradient-to-r ${theme === "dark"
...
const getNavButtonClasses = (theme) => {
  return `px-4 py-2 rounded-xl font-medium transition-all duration-300 border backdrop-blur-xl transform-gpu will-change-transform relative overflow-hidden group ${theme === "dark"
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`flex items-center space-x-2 font-semibold text-sm transition-colors duration-300 min-w-[80px] ${theme === "dark" ? "text-slate-100 hover:text-white" : "text-slate-700 hover:text-slate-900"
          }`}
      ...
      >
        ...
        <svg
          className={`w-3 h-3 text-slate-500 transition-all duration-300 ${isOpen ? 'rotate-180 text-teal-500' : 'text-slate-500 hover:text-teal-500'
            }`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
      ...
      {isOpen && (
        <div className={`absolute top-full right-0 mt-2 w-64 rounded-2xl backdrop-blur-2xl border shadow-2xl z-50 overflow-hidden ${theme === "dark"
          ...
          {/* Premium Footer */}
          <div className={`px-4 py-2 border-t text-center ${theme === "dark"
  ...
  <div className="flex items-center cursor-pointer group transform-gpu will-change-transform" onClick={onClick}>
    ...
    <div className="hidden md:flex flex-col min-w-0">
      <div className="flex items-baseline">
        <span className={`text-3xl font-black tracking-tight bg-gradient-to-r ${theme === "dark"
          ? "from-teal-300 via-emerald-300 to-cyan-300"
          : "from-teal-600 via-emerald-600 to-cyan-600"
          } text-transparent bg-clip-text font-sans whitespace-nowrap group-hover:bg-gradient-to-r ${theme === "dark"
                ...
                <div className="flex items-center space-x-1">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`px-2 py-1 rounded text-xs font-medium transition-all duration-200 ${selectedView === view.id
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`px-2 py-0.5 text-xs border rounded bg-white/80 focus:outline-none focus:ring-1 w-24 ${jumpError
                  ...
                  <button
                    ...
                    disabled={isJumping}
                    className={`px-2 py-0.5 text-white text-xs font-medium rounded transition-colors duration-200 ${isJumping
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 dark:scrollbar-thumb-slate-400 scrollbar-track-transparent" style={{ maxHeight: "calc(100vh - 240px)" }}>
            ...
            <div className={`px-5 py-4 border-b ${theme === "dark" ? "border-slate-700/50 bg-slate-800/20" : "border-slate-200/50 bg-slate-50/30"
              ...
              `}>
                ...
                {/* Text */}
                <div className="flex-1 min-w-0">
                  <div className={`text-xs font-bold mb-0.5 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-700'
                    }`}>
                    Your Location
                  </div>
                  <div className={`text-xs truncate font-medium ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
                    }`}>
                    Kathmandu, Nepal
                  </div>
                </div>
                ...
                <div className="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${theme === 'dark' ? 'bg-slate-700/50' : 'bg-slate-100/50'
                    }`}>
            ...
            <div className="p-4">
              {menuItems.map((category, categoryIndex) => (
                <div key={category.category} className={categoryIndex > 0 ? 'mt-5' : ''}>
                  ...
                  `}>
                      <category.icon className={`text-sm ${category.color === 'teal'
                  ...
                  <div className="space-y-1.5">
                    {category.items.map((item) => (
                      ...
                      `}>
                        ...
                        <svg
                          className={`w-4 h-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-200 flex-shrink-0 ${theme === "dark" ? "text-teal-400" : "text-teal-600"
                            }`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
          ...
          {/* Footer */}
          <div className={`px-5 py-3 border-t text-center ${theme === "dark"
            ? "bg-slate-800/40 border-slate-700/50"
            : "bg-slate-50/60 border-slate-200/50"
            }`}>
...
const FeaturesBox = ({ theme, onNavigation }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className={`absolute top-full right-0 mt-2 w-[400px] max-w-[90vw] rounded-2xl backdrop-blur-2xl border shadow-2xl z-50 overflow-hidden ${theme === "dark"
          ? "bg-slate-900/95 border-slate-700/50 shadow-slate-900/50"
          : "bg-white/95 border-slate-200/50 shadow-slate-200/50"
          }`}>
          {/* Premium Header */}
          ...
          {/* Premium Footer */}
          <div className={`px-6 py-4 border-t text-center ${theme === "dark"
            ? "bg-slate-800/40 border-slate-700/50"
            : "bg-slate-50/60 border-slate-200/50"
            }`}>
